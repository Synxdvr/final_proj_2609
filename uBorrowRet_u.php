...
<?php 
     ...
     if (isset($_POST['request']))  {
        ...
        $lastnmame =   $_POST['last_name'];
        $firstname =   $_POST['first_name'];
        $dateborrowed =   $_POST['date_borrowed'];
        $datereturned =   $_POST['date_returned'];

        $sub = mysqli_query($conn,"insert into pending_list(subject,content,status)value('$booktitle','$lastname','$firstname', '$dateborrowed','$datereturned,'pending')");
